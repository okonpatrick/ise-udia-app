                    ...
                    <div className="p-6 space-y-4 md:space-y-3 sm:p-10">
                        ...
                        <form className="space-y-4 md:space-y-6" action="#">
                            <div className='flex'>
                                ...
                                <div className='pl-4'>
                                    <label htmlFor="text" className="block mb-2  pl-4 text-sm font-medium text-gray-900 dark:text-white">Last Name</label>
...
<div className="flex">
      <div>
        <label htmlFor="lga" className="block mb-2 text-sm font-medium text-black dark:text-white">L.G.A</label>
        <select
          id="lga"
